...
$insertWebSettingQuery = "insert into web_setting 
                          (name, title_hotel, logo, small_logo, hotline, map_url, email, background_img, slogan, slogan_author, intro_youtube_url)
                    values 
                          ('$name', '$title_hotel', '$filename', '$filename1', '$hotline', '$map_url', '$email', '$filename2', '$slogan', '$filename3', '$intro_youtube_url')";
