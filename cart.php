                ...
                <div class="row">
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <div class="cart-left-side">
                            <h4>Tạm tính <span class="label label-default pull-right"> <?php
                  $diff = strtotime($booking['check_out']) - strtotime($booking['check_in']);
                  $total_date = round($diff / (60 * 60 * 24));
                  echo $total_date.' Ngày';
                    ?> </span></h4>
                            <h3>Tổng tiền<noscript></noscript> <span class="label label-default pull-right">
                        ...
                        <div class="rq-cart-table">
                            <table class="table" style="width:100%;">
                                ...
                                <tr class="rq-table-border">
                                    ...
                                    <td class="rq-align"><span><?php echo $total; ?></span> </td>
                                </tr>
                            </table>
                        </div>
                    </div>
